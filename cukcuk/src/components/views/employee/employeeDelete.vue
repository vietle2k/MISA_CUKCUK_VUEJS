    ...
    <div>
        ...
        <div class="confirm_box">
            <div class="dialog_header">
                <div class="dialog_title" style="font-size: 15px;">XÓA NHÂN VIÊN</div>
                <button class="button_X" @click="btnConfirmBoxClose()"></button>
            </div>
            <div class="confirm_box_content">
                <div style="font-style:italic; font-size: 16px;">Bạn chắc chắn muốn xóa nhân viên <b>{{employee.EmployeeCode}}</b> không?</div>
            </div>
